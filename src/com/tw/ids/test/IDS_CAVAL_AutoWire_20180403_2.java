 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180403_2 {
	...
	private static void writeToNewXMLDocument(Document document)
		...
		XMLWriter writer = new XMLWriter(new FileWriter(
				"D:\\eclipse_wks\\IDS_Test\\20180413\\IntegratorDesign4_D_2.xml"));
		// XMLWriter writer = new XMLWriter(new FileWriter(
	...
	private static Document getDocument() throws Exception {
		...
		Document document = sr
				.read("D:\\eclipse_wks\\IDS_Test\\20180413\\IntegratorDesign4_D_1.xml");
		// Document document =
