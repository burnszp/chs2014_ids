...
/**
 * 获取一个harness各个设备到其他设备中的路径,对于多于一条的路径要添加node，形成through node，（through
 * node和node的区别是：node节点的isreference和ismarker为1的是through node）
 * 
 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180411_1 {
	...
	private static Document getDocument() throws Exception {
		...
		Document document = sr
				.read("D:/eclipse_wks/IDS_Test/IntegratorDesign2_20180329.xml");
		// Document document =
