...
/**
 * 该类只能处理integrator中中两个设备之间的harness路径中有node，并且有多个bundle的情况，而且是一个harness下一个bundle。
...
*
 */
public class IDS_CAVAL_AutoWire_20180330 {
...
//        		System.out.println(id.getValue());
    ...
    private static Element readAllElementsFromXMLDocument(Document document) {
        Element root = document.getRootElement();
        Element topoplane = root.element("designmgr").element("topologydesign").element("planedesign").element("topoplane");
        return topoplane;
    }
