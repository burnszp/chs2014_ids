...
/**
 * 该类只能处理integrator中harness为直线的情况，而且是一个harness下一个bundle。
...
*
 */
public class IDS_CAVAL_AutoWire {
   ...
   */
    ...
    private static void writeToNewXMLDocument(Document document)
        ...
        XMLWriter writer = new XMLWriter(new FileWriter(
                "D:/eclipse_wks/IDS_Test/testintegrator_edited_update.xml"));
//        XMLWriter writer = new XMLWriter(new FileWriter(
//                "D:/eclipse_wks/IDS_Test/integratorDesign1_update.xml"));
    ...
    private static Document getDocument() throws Exception {
        ...
        Document document = sr.read("D:/eclipse_wks/IDS_Test/testintegrator_edited.xml");
