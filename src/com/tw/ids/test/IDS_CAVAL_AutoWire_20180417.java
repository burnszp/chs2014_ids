 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180417 {
...
//			List<Element> virtualharnessList1 = topoplane.elements("virtualharness");
//			System.out.println("virtualharnessList1.size():"
//					+ virtualharnessList1.size());

			final Element virtualharness = (Element) virtualharnessList.get(i);
			...
			if (toponodeLinkDeviceList.size() > 1) {
				...
				Thread t = new Thread(new Runnable() {
					...
					public void run() {
						...
						handleIntegrator(virtualharness, idMax, nodeAndToponodeMap,
	...
	private static void handleIntegrator(Element virtualharness, int idMax,
		...
		// if (toponodeLinkDeviceList.size() > 1) {
		// handleIntegrator(virtualharness, idMax ,
