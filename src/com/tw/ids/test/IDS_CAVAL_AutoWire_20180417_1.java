...
/**
 * 每个harness涉及到的设备都通过一个点，连接起来，按照最短路径来链接。
 * 
 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180417_1 {
...
//			toponode.addAttribute("ismarker", "0");
	...
	private static void writeToNewXMLDocument(Document document)
		...
		XMLWriter writer = new XMLWriter(new FileWriter(
				"D:/eclipse_wks/IDS_Test/20180417/IntegratorDesign4_20180417_4.xml"));
		// XMLWriter writer = new XMLWriter(new FileWriter(
	...
	private static Document getDocument() throws Exception {
		...
		Document document = sr
				.read("D:/eclipse_wks/IDS_Test/20180417/IntegratorDesign4_20180417_3.xml");
		// Document document =
