 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180418 {
...
//						Double.toString(Math.sqrt(Double.parseDouble(result))));
	...
	private static void writeToNewXMLDocument(Document document)
		...
		XMLWriter writer = new XMLWriter(new FileWriter(
				"D:/eclipse_wks/IDS_Test/20180418/tw_20180417_original_1.xml"));
		// XMLWriter writer = new XMLWriter(new FileWriter(
	...
	private static Document getDocument() throws Exception {
		...
		Document document = sr
				.read("D:/eclipse_wks/IDS_Test/20180418/tw_20180417_original.xml");
		// Document document =
