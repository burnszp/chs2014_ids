 ...
 * 
 */
public class IDS_CAVAL_AutoWire_20180404 {
	...
	private static void ModifyInformationOfXMLDocument(Element topoplane)
		...
		for (int i = 0; i < virtualharnessList.size(); i++) {
			...
			for (Element topobundle : topobundleList) {
				...
				/**
				 * 删除所有的topobundle下的topojoint
				 */
				List<Element> topojointList = topobundle.elements("topojoint");
				for (Element topojoint : topojointList) {
					topobundle.remove(topojoint);
				}
	...
	private static void writeToNewXMLDocument(Document document)
		...
		XMLWriter writer = new XMLWriter(new FileWriter(
				"D:\\eclipse_wks\\IDS_Test\\20180411\\tw_ids_integrator_1.xml"));
		// XMLWriter writer = new XMLWriter(new FileWriter(
	...
	private static Document getDocument() throws Exception {
		...
		Document document = sr
				.read("D:\\eclipse_wks\\IDS_Test\\20180411\\tw_ids_integrator.xml");
		// Document document =
